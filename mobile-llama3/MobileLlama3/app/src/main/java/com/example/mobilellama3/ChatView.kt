...
fun ChatView(
    ...
    Scaffold(topBar = {
        TopAppBar(
            ...
            colors = TopAppBarDefaults.topAppBarColors(containerColor = Color(0xFF5C4200)),
            navigationIcon = {
                IconButton(
    ...
    Row(
        ...
        OutlinedTextField(
            ...
            colors = OutlinedTextFieldDefaults.colors(
                focusedTextColor = Color(0xFF402D00),
                unfocusedTextColor = Color(0xFF5C4200),
                focusedBorderColor = Color(0xFF402D00),
                unfocusedBorderColor = Color(0xFF5C4200),
                focusedLabelColor = Color(0xFF402D00),
                unfocusedLabelColor = Color(0xFF5C4200)
            ),
